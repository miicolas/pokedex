...
let imgLoaded = false;
const featuredPokemon = [1, 25, 6, 150]; // Bulbasaur, Pikachu, Charizard, Mewtwo

// Rotation automatique des Pokémon
onMount(() => {
...
<div class="relative min-h-[85vh] overflow-hidden">
	<!-- Fond avec motif pokéball subtil -->
			...
			<div class="flex flex-col gap-10 lg:gap-16 col-span-1 lg:col-span-5 relative z-10">
				<div class="space-y-6">
					<h1 class="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight">
						...
						<span class="inline-block transform hover:scale-105 transition-transform bg-gradient-to-r from-blue-600 to-red-600 text-transparent bg-clip-text">Pokemon</span>
					</h1>

					<p class="text-xl lg:text-2xl text-gray-800 leading-relaxed">
						Explorez l'univers fascinant des Pokémon avec PokeAPI. Découvrez des informations détaillées sur chaque Pokémon,
